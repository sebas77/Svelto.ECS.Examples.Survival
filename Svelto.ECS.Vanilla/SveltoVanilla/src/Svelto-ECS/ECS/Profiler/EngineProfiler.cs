...
namespace Svelto.ECS.Profiler
{
    public sealed class EngineProfiler
    {
        ...
        public static void MonitorAddDuration(Action<IHandleEntityViewEngine, EntityView> addingFunc, IHandleEntityViewEngine engine, EntityView entityView)
        {
            EngineInfo info;
        ...
        public static void MonitorRemoveDuration(Action<IHandleEntityViewEngine, EntityView> removeFunc, IHandleEntityViewEngine engine, EntityView entityView)
        {
            EngineInfo info;
            if (engineInfos.TryGetValue(engine.GetType(), out info))
            {
