...
namespace Svelto.ECS
{
    public interface IEntitiesDB
    {
        ...
        /// <summary>
        /// Fast and raw (therefore not safe) return of entities buffer. Modifying a buffer would compromise the
        /// integrity of the whole DB so they are meant to be used only in performance critical path
        /// </summary>
