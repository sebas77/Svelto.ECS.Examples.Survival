...
namespace Svelto.ECS
{
    public partial class EntityBuilder<T> : IEntityBuilder where T : IEntityStruct, new()
    {
        ...
        {
            CheckInvalidFields(ENTITY_VIEW_TYPE, NEEDS_REFLECTION, true);
            
            CheckFieldsForDataBinding(ENTITY_VIEW_TYPE);
        ...
        public IEnumerable<DataBindsToAttribute> Attributes
        {
        ...
        internal static IEnumerable<DataBindsToAttribute> _ATTRIBUTES;
    }
}