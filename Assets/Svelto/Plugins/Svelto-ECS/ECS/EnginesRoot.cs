...
namespace Svelto.ECS
{
    public sealed class EnginesRoot : IEntityFunctions, IEntityFactory, IDisposable
    {
        ...
        public void RemoveEntity(int entityID, IEntityDescriptor template)
        {
            InternalRemove(template.entityViewsToBuild, entityID, _entityViewsDB);
        }
        ...
        class GenericEntityFunctions : IEntityFunctions
        {
            ...
            public void RemoveEntity(int entityID, IEntityDescriptor entityTemplate)
            {
